    ...
    string INPUT_FILE = "IO/inputs.in";
    ...
    class Network
    {
        public:
            ...
            double GET_DERIVATIVE(double value, int activation_func) {
                switch (activation_func) {
                    case 0: // SIGMOID
            ...
            void backpropagate(double learning_rate, int epochs, const TrainingData &data) {
